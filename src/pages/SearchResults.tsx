...
export default function SearchResults() {
  ...
  // 真实数据 - 参考 chaobanwang.com 和其他房地产网站
  const allBuildings: Building[] = [
    ...
    },
    {
      ...
      price: "4.8元/m²/天 起",
      image: vankeCenter,
      tags: ["1000m²", "1500m²", "2000m²", "2800m²", "3500m²"],
      description: "上海市闵行区申虹路",
      businessArea: "虹桥商务区"
    },
    {
      id: 13,
      ...
      price: "5.2元/m²/天 起",
      image: exhibitionHub,
      tags: ["1600m²", "1980m²", "2500m²", "3000m²", "3600m²"],
